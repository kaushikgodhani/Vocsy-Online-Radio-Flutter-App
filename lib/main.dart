...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Radio App',
      theme: ThemeData.dark().copyWith(backgroundColor: Color(0xFF26242e)),
      home: Directionality(
...
class _MyHomePageState extends State<MyHomePage>
 ...
 // GlobalKey<ScaffoldState> _globalKey = GlobalKey();
  ...
  final GlobalKey<SideMenuState> _scaffoldKey = new GlobalKey<SideMenuState>();
  @override
  Widget build(BuildContext context) {
    ...
    return  SafeArea(
          child: SideMenu(
            background: Colors.white,radius: BorderRadius.circular(15),
  ...
  TabBar getTabBar() {
    return TabBar(
      labelStyle: TextStyle(fontFamily: 'Nunito', fontWeight: FontWeight.w600),
      tabs: <Tab>[
        Tab(
          text: 'Home',
        ),
...
// initialise the plugin. app_icon needs to be a added as a drawable resource to the Android head project
  ...
  AppBar getAppbar() {
    return AppBar(
      title: appBarTitle,
    leading: IconButton(
      icon: SvgPicture.asset('assets/image/manu.svg',width: 50,height: 80,fit: BoxFit.cover,),
      onPressed: () {
        final _state = _scaffoldKey.currentState;
        if (_state.isOpened)
